...
#openai.api_key = "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"  

#def granite_generate(prompt: str) -> str:
 #   response = openai.ChatCompletion.create(
  #      model="gpt-3.5-turbo",  # or granite model name
